...
if(isset($_POST['envoyer'])) { // si le bouton "Envoyer" est appuyé
    ...
    if(empty($_POST['mail'])) {
        echo "ERREUR : Le champ mail est vide";?><br /><br /><a href="nouscontacter.html">Retourner à la page précédente</a><br /><br /><br /><?php
        ...
        if(!preg_match("#^[a-z0-9_-]+((\.[a-z0-9_-]+){1,})?@[a-z0-9_-]+((\.[a-z0-9_-]+){1,})?\.[a-z]{2,}$#i",$_POST['mail'])){
            echo "ERREUR : L'adresse e-mail est incorrecte";?><br /><br /><a href="nouscontacter.html">Retourner à la page précédente</a><br /><br /><br /><?php
			echo " (je ferai le design de cette page plus tard)";
        }else{
            //on vérifie que le champ sujet est correctement rempli
            if(empty($_POST['sujet'])) {
                echo "ERREUR : Le champ sujet est vide";?><br /><br /><a href="nouscontacter.html">Retourner à la page précédente</a><br /><br /><br /><?php
				echo " (je ferai le design de cette page plus tard)";
            }else{
                //on vérifie que le champ message n'est pas vide
                if(empty($_POST['message'])) {
                    echo "ERREUR : Le champ message est vide";?><br /><br /><a href="nouscontacter.html">Retourner à la page précédente</a><br /><br /><br /><?php
					echo " (je ferai le design de cette page plus tard)";
                }else{
                    ...
                    if(mail($VotreAdresseMail,utf8_encode($Sujet),nl2br($Message),$Entetes)) { //la fonction nl2br permet de conserver les sauts de ligne et la fonction urf8_encore de conserver les accents dans le titre
                        echo "Le mail a été envoyé avec succès !";?><br /><br /><a href="nouscontacter.html">Retourner à la page précédente</a><br /><br /><br /><?php
						echo " (je ferai le design de cette page plus tard)";
                    } else {
                        echo "ERREUR : Une erreur est survenue, le mail n'a pas été envoyé";?><br /><br /><a href="nouscontacter.html">Retourner à la page précédente</a><br /><br /><br /><?php
						echo " (je ferai le design de cette page plus tard)";
                    }
                }
            }
